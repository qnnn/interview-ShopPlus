...
CREATE TABLE `ums_admin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1330115617470132226 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_admin
-- ----------------------------
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', 'https://data-repository-1304879813.cos.ap-guangzhou.myqcloud.com/434f4027-5b6d-4454-a0b0-800a321406ec.png', 'diaxiahu@qq.com', '郭富城', '超级管理员', '2018-10-08 13:32:47', '2021-03-02 17:59:00', 1);
